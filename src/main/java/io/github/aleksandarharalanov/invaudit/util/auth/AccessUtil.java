package io.github.aleksandarharalanov.invaudit.util.auth;
...
public final class AccessUtil {
     ...
     */
    public static boolean hasPermission(CommandSender sender, String permission, String noPermissionMessage) {
